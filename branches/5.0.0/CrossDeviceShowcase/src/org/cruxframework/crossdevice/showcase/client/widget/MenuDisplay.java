 ...
 */
@Templates({
	@Template(name="menuDisplayLarge", device=Device.all),
	@Template(name="menuDisplaySmall", device=Device.smallDisplayArrows),
	@Template(name="menuDisplaySmall", device=Device.smallDisplayTouch)
})
public interface MenuDisplay extends DeviceAdaptive
{
	void showMenu();
