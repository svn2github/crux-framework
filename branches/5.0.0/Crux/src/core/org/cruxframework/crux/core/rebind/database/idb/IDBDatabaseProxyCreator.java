 ...
 * 
 */
public class IDBDatabaseProxyCreator extends AbstractInterfaceWrapperProxyCreator
{
	...
	protected void generateFileStoreCreation(SourcePrinter srcWriter)
    {
		if (!databaseMetadata.overrideDBElements())
		{
			srcWriter.println("if (!storeNames.contains("+EscapeUtils.quote(IDXFileStore.OBJECT_STORE_NAME)+")){");
		}
