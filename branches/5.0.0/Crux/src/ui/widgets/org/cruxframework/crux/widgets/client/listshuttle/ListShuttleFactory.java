...
@DeclarativeFactory(id = "listShuttle", library = "simco", targetWidget = ListShuttle.class)
@TagChildren({ @TagChild(value = ListShuttleFactory.ContentProcessor.class) })
@TagAttributes({ @TagAttribute(value = "id", required = true),
...
public class ListShuttleFactory extends WidgetCreator<WidgetCreatorContext> {
	...
	public static class ContentProcessor extends
	AnyWidgetChildProcessor<WidgetCreatorContext> {
	}
}
