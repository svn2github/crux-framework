 ...
 *
 */
@Resource(value="homeResources", supportedDevices={Device.largeDisplayArrows, Device.largeDisplayMouse, Device.largeDisplayTouch})
public interface HomeResourcesLarge extends ClientBundle
{
