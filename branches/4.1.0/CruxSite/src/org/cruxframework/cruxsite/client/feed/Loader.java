...
public final class Loader {
  ...
  static native void ajaxFeedLoad(JavaScriptObject google) /*-{
   ...
   @org.cruxframework.cruxsite.client.feed.Loader::startTimer()();
   }-*/;
  ...
  private static native Element getDocument(Element elt) /*-{
   ...
   if (!doc) {
   @org.cruxframework.cruxsite.client.feed.Loader::throwRuntimeException(Ljava/lang/String;)("Unable to obtain sandbox");
   }
  ...
  private static native void registerSandboxCallback() /*-{
   $wnd.AjaxFeedError = @org.cruxframework.cruxsite.client.feed.Loader::ajaxFeedError(Lcom/google/gwt/core/client/JavaScriptObject;);
   $wnd.AjaxFeedLoad = @org.cruxframework.cruxsite.client.feed.Loader::ajaxFeedLoad(Lcom/google/gwt/core/client/JavaScriptObject;);
   }-*/;
