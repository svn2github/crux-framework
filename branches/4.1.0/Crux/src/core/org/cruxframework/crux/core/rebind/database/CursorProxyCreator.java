...
public class CursorProxyCreator extends AbstractKeyValueProxyCreator
{
	...
	public CursorProxyCreator(GeneratorContextExt context, TreeLogger logger, JClassType targetObjectType, String objectStoreName, String[] keyPath)
	{
	...
	{
		String typeName = getTargetObjectClassName().replaceAll("\\W", "_");
