...
//TODO: implementar avancar e voltar (cross device.... com slide nos dispositivos com touch e suporte a teclado para desktop e dispositivos sem touch)
 ...
 */
@Templates({
	@Template(name="slideshowKeyboard", device=Device.all)
//	@Template(name="slideshowKeyboard", device=Device.largeDisplayMouse)
})
public interface Slideshow extends DeviceAdaptive
{
	public static enum Position{center, lineStart, lineEnd, east, north, south, west, none}
