package org.cruxframework.crux.crossdevice.rebind.anchor;
...
import org.cruxframework.crux.crossdevice.client.anchor.Anchor;
 ...
 *
 */
@DeclarativeFactory(library="crossDevice", id="anchor", targetWidget=Anchor.class)
