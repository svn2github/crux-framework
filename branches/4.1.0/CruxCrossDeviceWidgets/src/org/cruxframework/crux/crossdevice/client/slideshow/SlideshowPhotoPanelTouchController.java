 ...
 *
 */
@Controller("slideshowPhotoPanelTouchController")
public class SlideshowPhotoPanelTouchController extends DeviceAdaptiveController implements SlideshowPhotoPanel
{
	SlideshowTouchPhotoPanel photoPanel;
	...
	protected void init()
	{
		...
		photoPanel = new SlideshowTouchPhotoPanel();
