...
public class Zoom
{
	...
	private native void addEventListeners() /*-{
		...
		$doc.addEventListener( 'keyup', function( event ) {
			if( @org.cruxframework.crux.widgets.client.animation.Zoom::getInstance()().@org.cruxframework.crux.widgets.client.animation.Zoom::getLevel()() !== 1 && event.keyCode === 27 ) {
				@org.cruxframework.crux.widgets.client.animation.Zoom::getInstance()().@org.cruxframework.crux.widgets.client.animation.Zoom::out()();
			}
		} );

		// Monitor mouse movement for panning
		$doc.addEventListener( 'mousemove', function( event ) {
			if( @org.cruxframework.crux.widgets.client.animation.Zoom::getInstance()().@org.cruxframework.crux.widgets.client.animation.Zoom::getLevel()() !== 1 ) {
				@org.cruxframework.crux.widgets.client.animation.Zoom::getInstance()().@org.cruxframework.crux.widgets.client.animation.Zoom::setMouseX(D)(event.clientX);
				@org.cruxframework.crux.widgets.client.animation.Zoom::getInstance()().@org.cruxframework.crux.widgets.client.animation.Zoom::setMouseY(D)(event.clientY);
			}
		} );
	}-*/;
	...
	private native void doMagnify(double pageOffsetX, double pageOffsetY, double elementOffsetX, double elementOffsetY, double scale) /*-{
		if( @org.cruxframework.crux.widgets.client.animation.Zoom::isSupported()() ) {
