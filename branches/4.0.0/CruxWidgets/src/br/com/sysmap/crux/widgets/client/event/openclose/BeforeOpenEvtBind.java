...
public class BeforeOpenEvtBind implements EvtProcessor<HasBeforeOpenHandlers>
{
	 ...
	 * @param widget
	 */
	public void bindEvent(CruxMetaDataElement element, HasBeforeOpenHandlers widget)
	{
