...
import br.com.sysmap.crux.widgets.client.event.openclose.BeforeOpenEvent;
import br.com.sysmap.crux.widgets.client.event.openclose.BeforeOpenHandler;
...
public class BeforeOpenEvtBind extends EvtProcessor
{
    ...
    public void processEvent(SourcePrinter out, String eventValue, String widget, String widgetId)
    {
		...
		out.println(widget+".addBeforeOpenHandler(new "+BeforeOpenHandler.class.getCanonicalName()+"(){");
		out.println("public void onBeforeOpen("+BeforeOpenEvent.class.getCanonicalName()+" event){");
