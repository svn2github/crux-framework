...
public class BeforeExpandEvtBind implements EvtProcessor<HasBeforeExpandHandlers>
{
	...
	public void bindEvent(CruxMetaDataElement element, HasBeforeExpandHandlers widget)
	{
