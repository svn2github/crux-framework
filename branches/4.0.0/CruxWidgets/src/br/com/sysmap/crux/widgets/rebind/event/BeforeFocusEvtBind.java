...
public class BeforeFocusEvtBind extends EvtProcessor
{
    ...
    public void processEvent(SourcePrinter out, String eventValue, String widget, String widgetId)
    {
		...
		out.println(widget+".addBeforeFocusHandler(new "+BeforeFocusHandler.class.getCanonicalName()+"(){");
		out.println("public void onBeforeFocus("+BeforeFocusEvent.class.getCanonicalName()+" event){");
