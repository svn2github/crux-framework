...
public class ValueChangeEvtBind extends EvtProcessor
{
	...
	public void processEvent(SourcePrinter out, WidgetCreatorContext context, String eventValue)
	{
		...
		out.println(context.getWidget()+".addValueChangeHandler(new "+ ValueChangeHandler.class.getCanonicalName()+"(){");
		out.println("public void onValueChange("+ValueChangeEvent.class.getCanonicalName()+" event){");
