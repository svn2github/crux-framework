...
public class DoubleClickEvtBind extends EvtProcessor
{
    ...
    public void processEvent(SourcePrinter out, WidgetCreatorContext context, String eventValue)
    {
		...
		out.println(context.getWidget()+".addDoubleClickHandler(new "+DoubleClickHandler.class.getCanonicalName()+"(){");
		out.println("public void onDoubleClick("+DoubleClickEvent.class.getCanonicalName()+" event){");
