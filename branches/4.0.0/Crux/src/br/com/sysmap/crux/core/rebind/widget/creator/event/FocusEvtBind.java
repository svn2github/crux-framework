...
public class FocusEvtBind extends EvtProcessor
{
    ...
    public void processEvent(SourcePrinter out, WidgetCreatorContext context, String eventValue)
    {
		...
		out.println(context.getWidget()+".addFocusHandler(new "+FocusHandler.class.getCanonicalName()+"(){");
		out.println("public void onFocus("+FocusEvent.class.getCanonicalName()+" event){");
