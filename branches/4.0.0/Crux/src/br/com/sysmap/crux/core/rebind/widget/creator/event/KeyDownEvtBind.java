...
public class KeyDownEvtBind extends EvtProcessor
{
    ...
    public void processEvent(SourcePrinter out, WidgetCreatorContext context, String eventValue)
    {
		...
		out.println(context.getWidget()+".addKeyDownHandler(new "+KeyDownHandler.class.getCanonicalName()+"(){");
		out.println("public void onKeyDown("+KeyDownEvent.class.getCanonicalName()+" event){");
