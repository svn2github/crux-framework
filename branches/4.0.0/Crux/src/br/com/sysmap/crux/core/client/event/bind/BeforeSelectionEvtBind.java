 ...
 *
 */
public class BeforeSelectionEvtBind implements EvtProcessor<HasBeforeSelectionHandlers<?>>
{
	...
	public void bindEvent(CruxMetaDataElement element, HasBeforeSelectionHandlers<?> widget)
	{
