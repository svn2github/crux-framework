...
class GadgetUtils
{
	static boolean useLongManifestName(TreeLogger logger, TypeOracle typeOracle, JClassType extendsGadget)
	{
	 ...
	 */
	static void writeAnnotationToElement(TreeLogger logger, Annotation a, Element elt, String... excludeNames) throws UnableToCompleteException
	{
	...
	static void writeLocalesToElement(TreeLogger logger, Document d, Element parent, GadgetLocale[] locales) throws UnableToCompleteException
	{
	 ...
	 */
	static JClassType getUserPrefsType(TreeLogger logger, TypeOracle typeOracle, JClassType extendsGadget) throws UnableToCompleteException
	{
	 ...
	 */
	static PreferenceGenerator getPreferenceGenerator(TreeLogger logger, JClassType extendsPreferenceType) throws UnableToCompleteException
	{
