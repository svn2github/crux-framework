...
public class GadgetShindigClassHandler
{
	...
	public void createNativeGadgetClass()
    {
		...
		createGadgetClassGetAditionalParamsFunction(controller.getConfiguration().isCajaEnabled(), controller.getConfiguration().getContainer().isDebug());
	...
	protected native void createGadgetClassChangeViewFunction(GridLayoutManagerController controller)/*-{
  		$wnd.CruxGadgetClass.prototype.changeView = function() {
			controller.@org.cruxframework.crux.gadgets.client.controller.GridLayoutManagerController::changeGadgetView(IZ)(this.id, this.isProfileView());  		
  		};
	}-*/;
	...
	protected native void createGadgetClassOpenMenuOptionsFunction(GridLayoutManagerController controller)/*-{
  		$wnd.CruxGadgetClass.prototype.openMenuOptions = function(menuOptionsButton) {
			controller.@org.cruxframework.crux.gadgets.client.controller.GridLayoutManagerController::openMenuOptions(ILjava/lang/String;Lcom/google/gwt/user/client/Element;Z)(this.id, this.cssClassTitleOptionsMenu, menuOptionsButton, this.hasViewablePrefs_());  		
  		};
	}-*/;
